...
void evaluateCommand(uint8_t c) {
  ...
  switch(c) {
    case MSP_COMMAND_1_FEEDBACK:
      ...
      zero_m1_kaki_ok =    (mode_motor_1&0x04)>>1;
      break;
    case MSP_COMMAND_2_FEEDBACK:
      ...
      zero_m2_kaki_ok =    (mode_motor_2&0x04)>>1;
      break;
    case MSP_COMMAND_3_FEEDBACK:
      ...
      zero_m3_kaki_ok =    (mode_motor_3&0x04)>>1;
      break;
    case MSP_COMMAND_4_FEEDBACK:
      ...
      zero_m4_kaki_ok =    (mode_motor_4&0x04)>>1;
      break;
    ...
    case MSP_COMMAND_5_FEEDBACK:
      ...
      zero_m5_kaki_ok =    (mode_motor_5&0x04)>>1;
    ...
    case MSP_COMMAND_6_FEEDBACK:
      ...
      zero_m6_kaki_ok =    (mode_motor_6&0x04)>>1;
    ...
    case MSP_COMMAND_7_FEEDBACK:
      ...
      zero_m7_kaki_ok =    (mode_motor_7&0x04)>>1;
    ...
    case MSP_COMMAND_8_FEEDBACK:
      ...
      zero_m8_kaki_ok =    (mode_motor_8&0x04)>>1;
